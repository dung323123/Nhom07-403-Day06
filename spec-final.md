...
Câu trả lời sai về nguyên liệu/dị ứng có thể gây hại sức khỏe người dùng. Thà nói "Tôi không chắc, hãy hỏi quán" còn hơn tự tin trả lời sai. Với bài toán tư vấn thực phẩm, false positive (AI nói "không có tôm" nhưng thực ra có) nguy hiểm hơn false negative (AI nói "không chắc" dù thực ra biết).
...
| --- | --- | --- |
| Accuracy câu trả lời về menu (so với ground truth từ merchant) | ≥90% | <80% trong 3 ngày liên tiếp |
| Response latency (end-to-end) | <10s (p95) | >15s thường xuyên |
| Cart conversion rate sau khi chat với AI | ≥40% | <20 sau 2 tuần |
| User satisfaction (thumbs up / tổng phản hồi) | ≥75% | <60% trong 1 tuần |
| Tỉ lệ AI tự nhận "không chắc" thay vì bịa | ≥90% với câu hỏi ngoài data | Phát hiện hallucination về allergen -> dừng ngay |
...
Giả định: AOV (giá trị đơn trung bình) = 60.000 VND. Nhân sự trực chat hiện tại: 1 người, lương ~6tr/tháng (~200k/ngày). AI cost: ~$0.005/lượt hỏi, trung bình 3 lượt/user.
...
| --- | --- | --- | --- |
| **Assumption** | 100 user chat/ngày, giảm hủy đơn 3% | 200 user chat/ngày, giảm hủy đơn 8% | 200 user chat/ngày, giảm hủy đơn 15% |
| **Cost AI** | 100 × 3 × $0.005 = $1.5/ngày (~37.500 VND) | 200 × 3 × $0.005 = $3/ngày (~75.000 VND) | 200 × 3 × $0.005 = $3/ngày (~75.000 VND) |
| **Benefit** | Tiết kiệm 200.000 VND/ngày nhân sự + 100 × 3% × 60.000 = **+380.000 VND/ngày** | Tiết kiệm 200.000 VND/ngày nhân sự + 200 × 8% × 60.000 = **+1.160.000 VND/ngày** | Tiết kiệm 200.000 VND/ngày nhân sự + 200 × 15% × 60.000 = **+2.000.000 VND/ngày** |
| **Net/ngày** | **+342.500 VND/ngày** | **+1.085.000 VND/ngày** | **+1.925.000 VND/ngày** |
| **Break-even** | Ngay từ ngày đầu | Ngay từ ngày đầu | Ngay từ ngày đầu |

**Kết luận:** hòa vốn ngay từ ngày đầu ở cả 3 kịch bản.


**Kill criteria:** Dừng triển khai nếu: 

(a) Tỉ lệ chốt đơn sau chat <15% sau 4 tuần liên tiếp, 

HOẶC (b) xảy ra sự cố dị ứng nghiêm trọng có thể quy kết về AI, 
